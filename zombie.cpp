...
void chapter2(Player &player) {
     ...
     " | |  | |/ _ \\/ __|/ _` | |/ _ \\| '_ \\ / _ \\ | __| |\n"
     " | |__| |  __/\\__ \\ (_| | | (_) | | | |  __/ | |_| |\n"
     " |_____/ \\___||___/\\__,_|_|\\___/|_| |_|\\___|  \\__|_|\n";
...
void chapterItemImpact(Player &player) {
     ...
     displayScene("Chapter 2.5: Changing Fate with Items", asciiArt);
...
string chapter4(Player &player) {
    ...
    "    | |  | |__   ___  | |_ _  __ _| |__   __ _| |_ ___| |__\n"

    "    | |  | '_ \\ / _ \\ | __| |/ _` | '_ \\ / _` | __/ __| '_ \\\n"

    "    | |  | | | |  __/ | |_| | (_| | | | | (_| | || (__| | | |\n"

    "    |_|  |_| |_|\\___|  \\__|_|\\__, |_| |_|\\__,_|\\__\\___|_| |_|\n"
...
string chapter5(Player &player) {
    ...
    " |_|   \\___||___/\\__|_| |_| \\_| |_| |_| |_|   |_|\\___|\\___|_|\\_\\  |______|\n";
